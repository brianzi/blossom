...
cdef class Graph:
    ...
    cdef void add_outer_edge(self, edge *e, node *node_in_tree):
        ...
        e.tag += TAG_PLUS_OUTER # sets double outer edge tag if already outer!
